...
export function MemorySection() {
  ...
  return (
    <section className="w-full py-16 flex flex-col items-center bg-white/40 backdrop-blur-md">
      <h2 className="text-3xl md:text-4xl font-romantic text-purple mb-10 drop-shadow">
        Memories
      </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl px-4">
        {memories.map((memory, idx) => (
          ...
          >
            <h3 className="text-2xl font-bold text-pink mb-2 font-romantic group-hover:drop-shadow-lg transition-all">
              {memory.title}
            </h3>
